            ...
            for line in account_lines:
                ...
                if account_lines[line].get('account_currency_id'):
                    ...
                    if account_currency_id.position == 'before':
                        acc_balance_in_fc = account_currency_id.symbol + ' ' + str(float(account_lines[line].get('balance_in_fc')))
                    else:
                        acc_balance_in_fc = str(float(account_lines[line].get('balance_in_fc'))) + ' ' + account_currency_id.symbol
                else:
