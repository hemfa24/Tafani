	...
	def action_validate(self):
		...
		if self.request_date_from:
			if self.request_unit_half or self.request_unit_hours:
				self._get_number_of_days(datetime(self.request_date_from.year,self.request_date_from.month,self.request_date_from.day),datetime(self.request_date_from.year,self.request_date_from.month,self.request_date_from.day),current_employee.id)
			else:
				self._get_number_of_days(datetime(self.request_date_from.year,self.request_date_from.month,self.request_date_from.day),datetime(self.request_date_to.year,self.request_date_to.month,self.request_date_to.day),current_employee.id)
		return True